...
public class MainPanel extends JPanel {
    ...
    public void setDestinationText(String modifiedText){
        destination.add(modifiedText);
        String destinationText = String.join("\n", destination);
        taDest.setText(destinationText);

    }

    public void setStatusText(String status){
        pnlSouth.setStatusText(status);
    }
