...
public class PanelConsumers extends JPanel {
    ...
    public void updateConsumerStatus(int index, String status) {
        switch (index) {
            case 0:
                lblIcaStatus.setText("Status: " + status);
                break;
            case 1:
                lblCoopStatus.setText("Status: " + status);
                break;
            case 2:
                lblCGStatus.setText("Status: " + status);
                break;
        }
    }
    ...
    private void createConsumer1()
    {
        ...
        pnlICA.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.black),"Consumer: 1 "));
        pnlICA.setBounds(19, 19,415, 100);
        pnlICA.setLayout(null);

        //Status
        lblIcaStatus = new JLabel("Status:" + controller.getStatusConsumer());
    ...
    private void createConsumer2()
    {
        ...
        pnlCOOP.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.black),"Consumer: 2"));
    ...
    private void createConsumer3()
    {
        ...
        pnlCG.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.black),"Consumer: 3"));
        ...
        btnCGStop.addActionListener(l -> {
            ...
            lblCGStatus.setText(controller.getStatusProducer());//TO DO
    ...
    public void setConsumerStatus(String consumerName, String status)
    {
    ...
    public void clearCargoList(String foodStore) {
        switch (foodStore) {
            case "ICA":
                lstIca.setText(""); // Clear the ICA list
                break;
            case "Coop":
                lstCoop.setText(""); // Clear the Coop list
                break;
            case "City Gross":
                lstCG.setText(""); // Clear the City Gross list
                break;
            default:
                break;
        }
